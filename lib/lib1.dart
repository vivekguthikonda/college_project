...
class Lib1 {
  ...
  getDiseases(String plant, List data) {
  ...
  getProp(String disease, List data, String prop) {
    int index = getIndex(disease, 'dis_name')[0];
    return data[index][prop];
  }

  getFromZip(String lang) {
  ...
  getIndex(String item, String col) {
   ...
   formIndex(int i, List data, String prop) {
    return data[i][prop];
  }

  getDiseaseImages(List diseases, List data) {
